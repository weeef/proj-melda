...
public:
  ...
  void update() 
  {
    //int i = 0;
     //while(i < 10) {
     if(_event_id_is("some_id")||_event_id_is("attack_id")||_event_id_is("block_id")){
     
 
    _add_yaml("battlescreen.yaml", {{"top_index",200}, {"input_index", 350}});
    //_add_yaml("three.yaml",{{"top_index", 900}, {"input_index", 100}});
    //_add_yaml("three.yaml",{{"top_index", 200}, {"input_index", 200}});
  ...
  if(_event_id_is("attack_id")){   //attack phase 1
    ...
    if(_event_id_is("block_id")){ //block phase 1
      _add_yaml("battlescreen.yaml", {{"top_index",200}, {"input_index", 350}});
      _add_yaml("threeslime.yaml", {{"top_index", 50}, {"input_index", 350}});
    _add_yaml("threemelda.yaml", {{"top_index", 50}, {"input_index", 350}});
    }
